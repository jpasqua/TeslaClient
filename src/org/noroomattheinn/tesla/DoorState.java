/*
 * DoorState.java - Copyright(c) 2013  All Rights Reserved, Joe Pasqua
 * Created: Jul 5, 2013
 */
...
/**
 * DoorState: Retrieve the state of the doors and panoramic roof.
 * <P>
 ...
 * DoorController, we have this DoorState object and a separate VehicleState
 * object for the other odds and ends.
 * 
 * @author Joe Pasqua <joe at NoRoomAtTheInn dot org>
 */
public class DoorState extends APICall {
    
    //
    // Constructors
    //
    
    public DoorState(Vehicle v) {
    ...
    public String toString() {
        ...
        if (hasPano()) {
            ...
            if (panoState() != DoorState.PanoPosition.unknown)
                sb.append(panoState());
